...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Consultório Dra Nara — Dashboard" },
      { name: "description", content: "Painel financeiro e operacional do consultório da Dra Nara." },
      { property: "og:title", content: "Consultório Dra Nara — Dashboard" },
